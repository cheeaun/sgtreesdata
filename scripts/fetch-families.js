...
(async () => {
  for (id in species) {
    await got
      .post(
        'https://www.nparks.gov.sg/ptmapi/TreeInformationApi/GetTreeInformation',
        {
          responseType: 'json',
          json: {
